...
#Just-In-Time (JIT) compilation to speed up your code
import numba as nb
...
class JuliaPlane(ArrayComplexPlane):    
    ...
    def __initplane__(self):
        ...
        #print(self.plane)
        #fv = np.vectorize(julia(self.c,100))
        #fv = julia(self.c)
    ...
    def show(self):
        plt.figure(1,(16,16))#12X12 inch
        plt.imshow(self.plane, interpolation = 'bicubic', cmap =('hot'), extent =(self.xmin,self.xmax,self.ymin,self.ymax) )
